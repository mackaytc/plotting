...
```{r line.facet.plots, fig.width=4, fig.height=3, message = F}
...
```{r basic.maps, fig.width=5, fig.height=4, message = F}
...
```{r map.continuous.var, fig.width=7, fig.height=5, message = F}

library(maps)
library(ggthemes)
library(gridExtra)

# Loading geographic data for states + counties in the US. 
